...
import { allCountries, allCountries2 } from "./country_data";
...
class MaterialUiPhoneNumber extends React.Component {
  ...
  async initialize(props) {
    const { countries, imageUrl } = await allCountries();
  ...
  getDropdownProps = () => {
    console.log("this staet in get dropdown", this.state);
